...
from workbench.inference.execution import validate_tensor_dtype
from workbench.inference.standard_runtimes import _prepared_inputs, _visualizations
...
def test_runtime_rejects_declared_input_shape_and_dtype_mismatches(monkeypatch) -> None:
    ...
    monkeypatch.setattr(
        "workbench.inference.standard_runtimes.prepare_input_2d",
