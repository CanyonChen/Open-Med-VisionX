...
需要 Python 3.10 或更高版本；CI 当前验证 Python 3.10–3.12。
...
- [模型插件开发](docs/PLUGIN_DEVELOPMENT.md)
- [LLM Provider 与云端图像安全](docs/LLM_SECURITY.md)
- [教学课程：从像素到多模态 AI](docs/TEACHING_CURRICULUM.md)
...
CI 将这项较重的验证放在独立的单个 CPU-only job 中，不会让常规 Python 版本矩阵
重复安装 PyTorch。
